(() => {
  ...
  (() => {
    ...
    (e.popup = new (class {
      ...
      (c.prototype.moveTo = function (e, t, s) {
      ...
      (c.prototype.moveBack = function (e, t, s) {
...
***************************************************************************** */
    ...
    var D = (function () {
      ...
      return (
        ...
        (e.prototype.find = function (e) {
          return $(this._getSelector(e, this.selector));
        }),
    ...
    var H = function (e, t, s, i) {
        void 0 === s && (s = 0);
        var n = $(e).attr("data-lg-size") || i;
        if (n) {
          var r = n.split(",");
          if (r[1])
        ...
        return (
          (e.prototype.generateSettings = function (e) {
            if (
              ...
              var t = m(
                m({}, this.settings.mobileSettings),
                this.settings.mobileSettings
              );
              this.settings = m(m({}, this.settings), t);
            }
          }),
            ...
            if (!(this.$container && this.$container.get())) {
              ...
              var n = this.settings.ariaLabelledby
                ...
                d =
                  ...
                  "\n                </div>\n            </div>\n        </div>\n        ";
              $(this.settings.container).append(d),
                document.body !== this.settings.container &&
                  $(this.settings.container).css("position", "relative"),
            ...
            if ("this" === this.settings.selector) this.items.push(this.el);
              ...
              if ("string" == typeof this.settings.selector)
                if (this.settings.selectWithin) {
                  var e = $(this.settings.selectWithin);
          ...
          (e.prototype.hideScrollbar = function () {
            if (this.shouldHideScrollbar()) {
              ...
              $(document.body).css(
                ...
                $(document.body).addClass("lg-overlay-open");
            }
          }),
          (e.prototype.resetScrollBar = function () {
            this.shouldHideScrollbar() &&
              ...
              $(document.body).removeClass("lg-overlay-open"));
          }),
              ...
              if (t) {
                ...
                ("." !== i && "#" !== i) ||
                  (t =
                    ...
                    !this.settings.dynamic
                      ? $(this.items).eq(e).find(t).first().html()
                      : $(t).first().html());
              } else t = "";
          ...
          (e.prototype.getDummyImageContent = function (e, t, s) {
            var i;
            if ((this.settings.dynamic || (i = $(this.items).eq(t)), i)) {
              var n = void 0;
              if (
          ...
          (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
            ...
            setTimeout(function () {
              e.addClass("lg-complete lg-complete_"),
                r.LGel.trigger(C, { index: t, delay: s || 0, isFirstSlide: n });
            }, a);
          }),
          ...
          (e.prototype.addSlideVideoInfo = function (e) {
            ...
            e.forEach(function (e, s) {
              (e.__slideVideoInfo = U(e.src, !!e.video, s)),
                e.__slideVideoInfo &&
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (f) {
                ...
                x = W(r, E || "", m, this.settings.strings.playVideo, h);
                n.prepend(x);
              } else if (h) {
              ...
              (r || h) &&
                ...
                this.LGel.trigger(g, { index: e }),
                this.lGalleryOn &&
                  ".lg-item" === this.settings.appendSubHtmlTo &&
                  this.addHtml(e);
            }
            var I = 0;
            y && !$(document.body).hasClass("lg-from-hash") && (I = y),
              this.isFirstSlideWithZoomAnimation() &&
                (setTimeout(function () {
                  n.removeClass(
              ...
              (this.isFirstSlideWithZoomAnimation() &&
                ...
                this.onLgObjectLoad(n, e, y, I, b, !(!h || !h.html5 || r)),
              (this.zoomFromOrigin && this.currentImageSize) ||
              ...
              this.$inner.on("touchend.lg", function (r) {
                if ("swipe" === e.touchAction) {
                  if (i) (i = !1), e.touchEnd(s, t, r);
                    ...
                    var o = $(r.target);
                    e.isPosterElement(o) && e.LGel.trigger(L);
                  }
          ...
          (e.prototype.enableDrag = function () {
            ...
            this.settings.enableDrag &&
              ...
              $(window).on("mousemove.lg.global" + this.lgId, function (r) {
                i &&
                  e.lgOpened &&
                  ((n = !0),
              ...
              $(window).on("mouseup.lg.global" + this.lgId, function (r) {
                if (e.lgOpened) {
                  var o = $(r.target);
                  n
                    ? ((n = !1), e.touchEnd(s, t, r), e.LGel.trigger(O))
                    : e.isPosterElement(o) && e.LGel.trigger(L),
                    i &&
                      ((i = !1),
          ...
          (e.prototype.keyPress = function () {
            var e = this;
            $(window).on("keydown.lg.global" + this.lgId, function (t) {
              e.lgOpened &&
                !0 === e.settings.escKey &&
                27 === t.keyCode &&
                (t.preventDefault(),
            ...
            return (
              ...
              setTimeout(function () {
                t.zoomFromOrigin &&
                  ...
                  t.$inner.empty(),
                  t.lgOpened && t.LGel.trigger(_, { instance: t }),
          ...
          (e.prototype.destroyGallery = function () {
            this.destroyModules(!0),
              this.settings.dynamic || this.invalidateItems(),
              $(window).off(".lg.global" + this.lgId),
              this.LGel.off(".lg"),
    ...
    var J = s(97);
    const ee = document.querySelectorAll("[data-gallery]");
    if (ee.length) {
      let ct = [];
      ee.forEach((e) => {
        ct.push({
          ...
          for (let s = 0, i = e.length; s < i; s += 1) {
            ...
            void 0 !== n &&
              ...
              (ce(t[i]) && ce(r[i])
                ...
                : !ce(t[i]) && ce(r[i])
                ? ((t[i] = {}),
                  r[i].__swiper__ ? (t[i] = r[i]) : ue(t[i], r[i]))
                : (t[i] = r[i]));
          }
        }
      }
    ...
    function he({ swiper: e, targetPosition: t, side: s }) {
      const i = oe(),
        n = -e.translate;
      let r,
        o = null;
    ...
    const ke = {
      updateSize: function () {
        ...
        (t =
          ...
          (0 === t && e.isHorizontal()) ||
            ...
            ((t =
              t -
              parseInt(fe(i, "padding-left") || 0, 10) -
              parseInt(fe(i, "padding-right") || 0, 10)),
            (s =
              s -
              parseInt(fe(i, "padding-top") || 0, 10) -
              parseInt(fe(i, "padding-bottom") || 0, 10)),
            Number.isNaN(t) && (t = 0),
            Number.isNaN(s) && (s = 0),
            Object.assign(e, {
              width: t,
      ...
      updateSlides: function () {
        ...
        const i = e.params,
          ...
          u = me(r, `.${e.params.slideClass}, swiper-slide`),
        ...
        "string" == typeof w && w.indexOf("%") >= 0
          ...
          i.centeredSlides &&
            i.cssMode &&
            (pe(n, "--swiper-centered-offset-before", ""),
            pe(n, "--swiper-centered-offset-after", ""));
          ...
          if (
            ...
            if ("auto" === i.slidesPerView) {
              ...
              if (
                ...
                E = e.isHorizontal() ? we(r, "width", !0) : we(r, "height", !0);
              else {
                const e = s(o, "width"),
                  t = s(o, "padding-left"),
                  i = s(o, "padding-right"),
        ...
        if (
          ...
          pe(n, "--swiper-centered-offset-before", -h[0] + "px"),
            pe(
              n,
      ...
      updateSlidesClasses: function () {
        const e = this,
          ...
          o = (e) => me(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
        let a;
        if (
          (t.forEach((e) => {
            e.classList.remove(
        ...
        if (
          ...
          if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -c;
            ...
            if (!r.support.smoothScroll)
              return (
                he({ swiper: r, targetPosition: -c, side: e ? "left" : "top" }),
                !0
              );
    ...
    function _e({ swiper: e, runCallbacks: t, direction: s, step: i }) {
      ...
      slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
        ...
        if (a.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!r.support.smoothScroll)
              return (
                he({ swiper: r, targetPosition: s, side: e ? "left" : "top" }),
                !0
              );
    ...
    const De = {
      loopCreate: function (e) {
        ...
        me(i, `.${s.slideClass}, swiper-slide`).forEach((e, t) => {
    ...
    const je = (e, t) => e.grid && t.grid && t.grid.rows > 1;
    const Re = {
      init: !0,
    ...
    const Ue = {
        ...
        transition: {
          ...
          transitionStart: function (e = !0, t) {
            ...
            i.cssMode ||
              ...
              _e({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
          },
          transitionEnd: function (e = !0, t) {
            ...
            (s.animating = !1),
              i.cssMode ||
                (s.setTransition(0),
                _e({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
          },
        },
        slide: ze,
        loop: De,
        ...
        events: {
          attachEvents: function () {
            ...
            (e.onTouchStart = $e.bind(e)),
              ...
              (e.onClick = Fe.bind(e)),
              (e.onLoad = Ve.bind(e)),
              Xe || (t.addEventListener("touchstart", Ne), (Xe = !0)),
              We(e, "on");
          },
        ...
        breakpoints: {
          setBreakpoint: function () {
            ...
            u && s && e.changeDirection(), ue(e.params, a);
    ...
    class Qe {
      constructor(...e) {
        ...
        (n.__swiper__ = !0),
          (n.support = xe()),
          (n.device = Ee({ userAgent: s.userAgent })),
          (n.browser = Le()),
          (n.eventsListeners = {}),
      ...
      getSlideIndex(e) {
        const { slidesEl: t, params: s } = this,
          i = ve(me(t, `.${s.slideClass}, swiper-slide`)[0]);
        return ve(e) - i;
      }
      ...
      recalcSlides() {
        ...
        this.slides = me(e, `.${t.slideClass}, swiper-slide`);
      }
      enable() {
        const e = this;
        e.enabled ||
      ...
      mount(e) {
        ...
        return (
          !n &&
            ...
            ((n = ge("div", t.params.wrapperClass)),
            s.append(n),
            me(s, `.${t.params.slideClass}`).forEach((e) => {
              n.append(e);
            })),
          Object.assign(t, {
            el: s,
            ...
            mounted: !0,
            rtl: "rtl" === s.dir.toLowerCase() || "rtl" === fe(s, "direction"),
            rtlTranslate:
              "horizontal" === t.params.direction &&
              ("rtl" === s.dir.toLowerCase() || "rtl" === fe(s, "direction")),
            wrongRTL: "-webkit-box" === fe(n, "display"),
          }),
          !0
        );
      }
    ...
    function Je({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function u(t) {
        return (
          ...
          !(
            ...
            le() - a < e.params.mousewheel.thresholdTime
          ) &&
          ((t.delta >= 6 && le() - a < 60) ||
            (t.direction < 0
      ...
      function p(t) {
        ...
        if (!e.mouseEntered && !c && !a.releaseOnEdges) return !0;
        ...
        if (a.forceToAxis)
          ...
          p =
            Math.abs(m.pixelX) > Math.abs(m.pixelY) ? -m.pixelX * h : -m.pixelY;
        if (0 === p) return !0;
        a.invert && (p = -p);
        ...
        if (
          ...
          const t = { time: le(), delta: Math.abs(p), direction: Math.sign(p) },
            n =
              o &&
              t.time < o.time + 500 &&
              t.delta <= o.delta &&
          ...
          if (!n) {
            o = void 0;
            let d = e.getTranslate() + p * a.sensitivity;
        ...
        e.params.createElements &&
          Object.keys(i).forEach((n) => {
            if (!s[n] && !0 === s.auto) {
              let r = me(e.el, `.${i[n]}`)[0];
              r ||
                ((r = ge("div", i[n])), (r.className = i[n]), e.el.append(r)),
                (s[n] = r),
                (t[n] = r);
            }
          }),
    ...
    function it({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function c(t) {
        const s = t.target.closest(st(e.params.pagination.bulletClass));
        if (!s) return;
        t.preventDefault();
        const i = ve(s) * e.params.slidesPerGroup;
        if (e.params.loop) {
      ...
      function u() {
        ...
        if (
          ...
          if (
            (s.dynamicBullets &&
              ((r = we(i[0], e.isHorizontal() ? "width" : "height", !0)),
              u.forEach((t) => {
        ...
        u.forEach((t, r) => {
          if (
            ("fraction" === s.type &&
              (t.querySelectorAll(st(s.currentClass)).forEach((e) => {
                e.textContent = s.formatFractionCurrent(n + 1);
              }),
              t.querySelectorAll(st(s.totalClass)).forEach((e) => {
            ...
            let o = 1,
              a = 1;
            "horizontal" === i ? (o = r) : (a = r),
              t.querySelectorAll(st(s.progressbarFillClass)).forEach((t) => {
                (t.style.transform = `translate3d(0,0,0) scaleX(${o}) scaleY(${a})`),
                  (t.style.transitionDuration = `${e.params.speed}ms`);
              });
          }
          "custom" === s.type && s.renderCustom
            ? ((t.innerHTML = s.renderCustom(e, n + 1, h)),
            ...
            "custom" !== t.type && (s.innerHTML = r || ""),
              "bullets" === t.type &&
                e.pagination.bullets.push(
                  ...s.querySelectorAll(st(t.bulletClass))
                );
          }),
        ...
        "string" == typeof t.el &&
          ...
          s &&
            ...
            (e.params.uniqueNavElements &&
              ...
              s.length > 1 &&
                (s = s.filter((t) => be(t, ".swiper")[0] === e.el)[0])),
      ...
      s("changeDirection", () => {
        ...
        s("init", () => {
          !1 === e.params.pagination.enabled ? g() : (h(), p(), u());
        }),
        s("activeIndexChange", () => {
    ...
    function nt({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function p() {
        ...
        s
          ? ((u = -u),
            u > 0 ? ((d = o - u), (u = 0)) : -u + o > a && (d = a + u))
          : u < 0
          ? ((d = o + u), (u = 0))
          : u + o > a && (d = a - u),
          e.isHorizontal()
            ? ((i.style.transform = `translate3d(${u}px, 0, 0)`),
              (i.style.width = `${d}px`))
            : ((i.style.transform = `translate3d(0px, ${u}px, 0)`),
              (i.style.height = `${d}px`)),
          r.hide &&
            (clearTimeout(c),
            (n.style.opacity = 1),
      ...
      function h() {
        ...
        (s.style.width = ""),
          (s.style.height = ""),
          (a = e.isHorizontal() ? i.offsetWidth : i.offsetHeight),
          (l =
            e.size /
            (e.virtualSize +
      ...
      function w() {
        ...
        "string" == typeof i.el &&
          e.isElement &&
          (r = e.el.shadowRoot.querySelector(i.el)),
          r || "string" != typeof i.el
            ? r || (r = i.el)
            : (r = n.querySelectorAll(i.el)),
          e.params.uniqueNavElements &&
            "string" == typeof i.el &&
            r.length > 1 &&
          ...
          r &&
            ((o = r.querySelector(`.${e.params.scrollbar.dragClass}`)),
            o || ((o = ge("div", e.params.scrollbar.dragClass)), r.append(o))),
      ...
      t({
        ...
        s("init", () => {
          !1 === e.params.scrollbar.enabled ? S() : (w(), h(), p());
        }),
    ...
    function rt({ swiper: e, extendParams: t, emit: s, once: i }) {
      t({
        freeMode: {
          enabled: !1,
          momentum: !0,
                  ...
                  if (l.velocities.length > 1) {
                    ...
                    (e.velocity = i / r),
                      ...
                      Math.abs(e.velocity) < n.freeMode.minimumVelocity &&
                        (e.velocity = 0),
                      (r > 150 || le() - t.time > 300) && (e.velocity = 0);
                  } else e.velocity = 0;
    ...
    if (
      (window.addEventListener("load", function (e) {
        document.querySelector(
          ...
          ".swiper-story",
          "swiper-form-lombard",
          ".swiper-lombard-image"
        ) &&
          (new Ze(".reviews-swiper", {
            modules: [tt, it],
            slidesPerView: "auto",
            spaceBetween: 16,
            navigation: {
          ...
          new Ze(".swiper-metall", {
            modules: [Je],
            slidesPerView: "auto",
            spaceBetween: 16,
            mousewheel: { sensitivity: 1 },
          }),
          new Ze(".swiper-information", {
            modules: [],
            slidesPerView: "4",
            spaceBetween: 16,
            mousewheel: { sensitivity: 1 },
      ...
      function ut() {
        ...
        var s = new ymaps.Clusterer({
          clusterDisableClickZoom: !1,
          clusterOpenBalloonOnClick: !1,
          clusterBalloonCycling: !1,
          clusterBalloonPagerVisible: !1,
        });
        s.add(t), e.geoObjects.add(s);
      }
      ymaps.ready(ut);
    }
    if (document.querySelector(".bottom-navigation")) {
      let pt = 0,
        ht = document.querySelector(".bottom-navigation");
      window.onscroll = function () {
        window.scrollY > pt
          ? (ht.classList.add("bottom-navigation_scroll-bottom"),
            ht.classList.remove("bottom-navigation_scroll-top"))
          : (ht.classList.add("bottom-navigation_scroll-top"),
            ht.classList.remove("bottom-navigation_scroll-bottom")),
          (pt = window.scrollY);
      };
    }
    if (document.querySelector(".lombard-addresses")) {
      let mt = document.querySelectorAll(".tariffs-triger"),
        gt = document.querySelectorAll(".form-lombard__slide"),
        ft = document.querySelectorAll(".form-lombard__line"),
        vt = document.querySelectorAll(".lombard-addresses-cart__button"),
        bt = document.querySelectorAll(".button-address"),
        yt = document.querySelector(".button-list"),
        wt = document.querySelector(".lombard-addresses-cart"),
        Tt = document.querySelectorAll(".lombard-addresses__button"),
        St = document.querySelectorAll(".form-lombard");
      for (let Ct = 0; Ct < mt.length; Ct++) {
        let xt = mt[Ct].querySelectorAll(".tariffs-triger__button");
        for (let Et = 0; Et < xt.length; Et++) {
          const Lt = xt[Et];
          Lt.addEventListener("click", function (e) {
            xt.forEach((e) => {
              e.classList.remove("tariffs-triger__button_active");
            }),
              Lt.classList.add("tariffs-triger__button_active");
          });
        }
      }
      for (let It = 0; It < gt.length; It++) {
        gt[It].addEventListener("click", function (e) {
          let t = document.querySelectorAll(".form-lombard");
          for (let e = 0; e < t.length; e++) {
            const e = t;
            console.dir(e[0]),
              e[0].classList.remove("form-lombard_active"),
              e[1].classList.add("form-lombard_active");
          }
          for (let e = 0; e < ft.length; e++) {
            ft[e].addEventListener("click", function (e) {
              for (let e = 0; e < t.length; e++) {
                const e = t;
                console.dir(e[0]),
                  e[1].classList.remove("form-lombard_active"),
                  e[0].classList.add("form-lombard_active");
              }
            });
          }
          for (let e = 0; e < vt.length; e++) {
            vt[e].addEventListener("click", function (e) {
              for (let e = 0; e < t.length; e++) {
                const e = t;
                console.dir(e[0]),
                  e[1].classList.remove("form-lombard_active"),
      ...
      for (let Mt = 0; Mt < bt.length; Mt++) {
        ...
        Ot.addEventListener("click", function (e) {
          for (let e = 0; e < Tt.length; e++) {
            const t = Tt[e];
            console.log(Ot),
              t.classList.remove("lombard-addresses__button_active"),
              Tt.forEach((e) => {
                e.addEventListener("click", function (t) {
                  e.classList.add("lombard-addresses__button_active");
                });
              });
          }
          St.forEach((e) => {
            e.classList.remove("form-lombard_active");
          }),
            wt.classList.add("lombard-addresses-cart_active");
        });
      }
      yt.addEventListener("click", function (e) {
        console.log("asdsad"),
          wt.classList.remove("lombard-addresses-cart_active");
        for (let e = 0; e < St.length; e++) {
          St[0].classList.add("form-lombard_active");
        }
      });
    }
    let ot = document.querySelector(".checkbox_main");
    ot.addEventListener("click", function (e) {
      ot.querySelector("input[type=checkbox]").checked
        ? (console.log("Да"),
          (document.querySelector(".estimation__title").style.opacity = 1))
        : (console.log("Нет"),
          (document.querySelector(".estimation__title").style.opacity = 0));
    });
    let at = document.querySelector(".gold"),
      lt = document.querySelector(".silver"),
      dt = document.querySelectorAll(".metall-item");
    (at || lt) &&
      (at.addEventListener("click", function (e) {
        document.querySelectorAll(".prices-metall__title").forEach((e) => {
          (e.children[0].className = "block"),
            (e.children[1].className = "none");
        }),
          dt.forEach((e) => {
            e.classList.contains("metall-item_silver") &&
              (e.classList.add("metall-item_gold"),
              e.classList.remove("metall-item_silver"));
          });
      }),
      lt.addEventListener("click", function (e) {
        document.querySelectorAll(".prices-metall__title").forEach((e) => {
          (e.children[0].className = "none"),
            (e.children[1].className = "block");
        }),
          dt.forEach((e) => {
            e.classList.contains("metall-item_gold") &&
              (e.classList.remove("metall-item_gold"),
              e.classList.add("metall-item_silver"));
          });
      })),
      (function (e) {
        let t = new Image();
            ...
            if (t.closest("[data-spoller]")) {
              const s = t.closest("[data-spoller]"),
                ...
                a = r.dataset.spollersSpeed
                  ...
                  : 500;
              if (!r.querySelectorAll("._slide").length) {
                if (o && !s.classList.contains("_spoller-active")) {
                  l(r);
                  let e = document.querySelectorAll(".FAQ-spollers__item");
                  console.log(e),
                    e.forEach((e) => {
                      e.classList.remove("active");
                    }),
                    console.dir(t.parentElement.classList.add("active"));
                } else t.parentElement.classList.remove("active");
